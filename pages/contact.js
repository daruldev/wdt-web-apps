...
const Contact = () => {
  return (
    <Layout bodyClass={"contact"}>
      <PageBanner pageName={"Kontak"} pageTitle={"Kontak Kami  "} />
            ...
            <div className="col-12">
              <div className="title-heading st-2">
                <div className="sub-heading clr-pri-3 f-mulish">
                  <LeftArrow />
                  <span className="inner-sub st-1">Butuh Dukungan Apa Pun</span>
                  <RightArrow />
                </div>
                <h2 className="title clr-pri-2">
                  Kami Siap Membantu Anda Untuk Mendapatkan Informasi
                </h2>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-md-5">
              <div className="title-heading">
                <div className="sub-heading clr-pri-3 f-mulish">
                  <span className="inner-sub">Kontak Kami </span>
                  <RightArrow />
                </div>
                <h2 className="title clr-pri-2 m-b26">
                  Jangan Ragu Untuk Kontak Kami Untuk Info Lebih Lanjut
                </h2>
              ...
              <div className="wrap-contact">
                <div className="fx adress">
                  ...
                  <div className="content">
                    <p>Alamat</p>
                    <h4>Jl. Batu Indah Raya No.40</h4>
                  </div>
                </div>
                <div className="fx Email">
                  ...
                  <div className="content">
                    <p>Alamat email</p>
                    <h4>kindergarten@whalez.tech</h4>
                  </div>
                </div>
        ...
        <div className="tf-section map">
          <div className="flat-map">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15841.88927914054!2d107.633738!3d-6.953478!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e844ac27538d%3A0x335bfd7adea1a8ff!2sJl.%20Batu%20Indah%20Raya%20No.40%2C%20Batununggal%2C%20Kec.%20Bandung%20Kidul%2C%20Kota%20Bandung%2C%20Jawa%20Barat%2040266!5e0!3m2!1sen!2sid!4v1656262906058!5m2!1sen!2sid"
              width={1720}
              height={655}
              style={{
                border: 0,
